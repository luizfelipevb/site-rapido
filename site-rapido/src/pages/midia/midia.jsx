...
function Midia({ pesquisa }) {
  ...
  return (
    <div className="container">
      ...
      <div className="lista">
        {/* VLC MEDIA PLAYER */}
        {(!termo || "vlc media player".includes(termo)) && (
          <div className="card">
            <img
        ...
        {(!termo || "windows media player".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* POTPLAYER */}
        {(!termo || "potplayer".includes(termo)) && (
          <div className="card">
            <img
        ...
        {(!termo || "media player classic home cinema".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* GOM PLAYER */}
        {(!termo || "gom player".includes(termo)) && (
          <div className="card">
            <img
