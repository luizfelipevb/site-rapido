...
<div className="card">
  ...
  <p>
    ...
    utilizado para reproduzir músicas, vídeos e outros arquivos multimídia
    no Windows.
  </p>
  <br />
  ...
  <p>
    <strong>Benefícios:</strong> Reprodução de áudio e vídeo integrada ao sistema.
  </p>
  <p>
    <strong>Restrições:</strong> Menos recursos avançados comparado a players modernos.
  </p>
  <br />
  ...
  <p>
    <strong>Benefícios:</strong> Interface moderna, suporte aprimorado e integração com Windows 11.
  </p>
  <p>
    <strong>Restrições:</strong> Disponível principalmente em versões recentes do Windows.
  </p>
  <br />
