  ...
  return (
    <div className="container">
      ...
      <div className="lista">
        ...
        {/* GOOGLE MAPS CARD */}
        {(!termo || "google maps".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* GOOGLE EARTH CARD */}
        {(!termo || "google earth".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* HERE WEGO CARD */}
        {(!termo || "here wego".includes(termo)) && (
        <div className="card">
          <img
