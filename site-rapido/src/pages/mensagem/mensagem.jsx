  ...
  return (
    <div className="container">
      ...
      <div className="lista">
        ...
        {/* Instagram */}
        {(!termo || "instagram meta".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* WhatsApp */}
        {(!termo || "whatsapp meta".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Messenger */}
        {(!termo || "messenger facebook meta".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Google Meet */}
        {(!termo || "google meet reunioes".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Microsoft Teams */}
        {(!termo || "microsoft teams".includes(termo)) && (
          <div className="card">
            <img
