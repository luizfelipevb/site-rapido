  ...
  return (
    <div className="container">
      ...
      <div className="lista">
        ...
        {/* Crunchyroll */}
        {(!termo || "crunchyroll".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Prime */}
        {(!termo || "primevideo".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Globo */}
        {(!termo || "globoplay".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Pluto */}
        {(!termo || "plutotv".includes(termo)) && (
          <div className="card">
            <img
              src="https://m.media-amazon.com/images/I/41+C5TFE3kL.png"
              alt="Pluto"
            />{" "}
            <br />
            <h2>PLUTO TV</h2>
