...
function Armazenamento({ pesquisa }) {
  ...
  return (
    <div className="container">
      ...
      {/* Google Drive */}
      {(!termo || "GoogleDrive google drive".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* Github */}
      {(!termo || "github git hub".includes(termo)) && (
        <div className="card">
          <img
      ...
      {/* Microsoft One Dive */}
      {(!termo || "microsoft one drive microsoftonedrive ".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* ICLOD DRIVE */}
        {(!termo || "iclouddrive icloud drive apple".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* DROPBOX*/}
        {(!termo || "dropbox drop box".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* Mega */}
        {(!termo || "MEGA mega".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* TERABOX */}
        {(!termo || "terabox tera box".includes(termo)) && (
        <div className="card">
          <img
        ...
        {/* PCLOUD */}
        {(!termo || "pcloud p cloud".includes(termo)) && (
        <div className="card">
          <img
