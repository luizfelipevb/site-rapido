  ...
  return (
    <div className="container">
      ...
      <div className="lista">
        ...
        {/* VISUAL STUDIO CODE */}
        {(!termo || "visual studio code".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* TEAMVIEWER */}
        {(!termo || "teamviewer".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* BALENAETCHER */}
        {(!termo || "balenaetcher".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* EVERYTHING SEARCH */}
        {(!termo || "everything search".includes(termo)) && (
          <div className="card">
            <img
