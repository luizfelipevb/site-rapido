  ...
  return (
    <div className="container">
      ...
      <div className="lista">
        ...
        {/* BlaBlaCar */}
        {(!termo || "blablacar".includes(termo)) && (
          <div className="card">
            <img
        ...
        {/* Skyscanner */}
        {(!termo || "skyscanner".includes(termo)) && (
          <div className="card">
            <img
